...
class Transcription(Base):
    ...
    # Validée d'un clic avec toutes les pages du document, pas relue une à une.
    # Indexée comme les autres, mais jamais prise pour référence d'évaluation.
    bulk_validated: Mapped[bool] = mapped_column(
